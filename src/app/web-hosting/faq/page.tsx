    ...
    <Container>
      <Row>
        <Col xs={12}>
          ...
          <p>
            I recommend using a payment processor that is PCI compliant. We use Square for billing, which is PCI compliant
            and securely encrypts and stores all payment information.
          </p>
        </Col>
      </Row>
    </Container>
