    ...
    <Container>
      ...
      <Row>
        <Col xs={12}>
          ...
          <p>
            This privacy policy explains how <span id="website-name">Ben Herila Website</span> (the "Website") collects,
            uses, and discloses information when you use our Website. We respect your privacy and are committed to
          ...
          <p>
            We collect two types of information from users of our Website: (1) personal information that users provide to
            us, and (2) non-personal information collected through Google Analytics.
          </p>
          ...
          <p>
            This personal information may include your name, email address, phone number, and any other information you
            provide to us.
          </p>
          ...
          <p>
            Google Analytics uses cookies to collect this information. You can learn more about Google Analytics' data
          ...
          <p>
            We do not sell, trade, or rent your personal information to third parties. We may disclose your information in
          ...
          <p>
            This website is not intended for use by individuals residing in the European Union (EU). We might not comply
            with the General Data Protection Regulation (GDPR) and other EU data protection laws. If you are an EU resident,
            please do not access or use this website, as we cannot ensure the protection of your personal data in accordance
            with EU standards. By using this website, you acknowledge that you are not an EU resident and consent to our
